...
void Dynamixel2Arduino::begin(unsigned long baud, uint32_t config, int rxPin, int txPin) {
    ...
    // Configurar Serial2 con los pines indicados
    Serial2.begin(baud, config, rxPin, txPin);

    // Configurar el puerto DYNAMIXEL
